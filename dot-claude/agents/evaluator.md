...
4. **Test it yourself** — Where possible, run tests, read test output, or trace the logic. Don't just read code and assume it works.
...
- If you cannot verify a criterion (e.g., no tests, no way to run code), mark it UNVERIFIABLE and flag it as a non-blocking issue.
